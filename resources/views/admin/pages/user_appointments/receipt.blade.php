			...
			<div class="widget-box">
				<div class="widget-header widget-header-large">
					...
					<div class="widget-toolbar no-border invoice-info">
                        ...
                        @endphp
						<span class="invoice-info-label">Date:{{$date}}
				...
				<div class="widget-body">
					<div class="widget-main padding-24" id="divToPrint">
						<div class="row">
							<div class="col-sm-6">
								<div class="row">
							...
							<div class="col-sm-6">
								...
								<div>
									<ul class="list-unstyled  spaced">
										<li>
											<i class="ace-icon fa fa-caret-right green"></i>Patient Name:{{$pay_receipt->user->name}}
										</li>
							...
							<table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        $total=0;
                                    @endphp
                                    @foreach($appointmentDetails as $key=>$receipt) 
                                    <tr>
                                     <th scope="row">{{$key}}</th> 
                                        <td>{{$receipt->test->name}}</td> 
                                        <td>{{$receipt->unit_price}}</td>
                                        <td>{{$receipt->subtotal_price}}</td>
                                        @php
                                            $total=$total+$receipt->subtotal_price;
                                        @endphp
                                        {{-- <td>{{$total}}</td> --}}
                                    </tr>
                                         @endforeach
