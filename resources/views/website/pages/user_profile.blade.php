...
<div class="container bootstrap snippet">
    ...
    <br>
          ...
          <div class="panel panel-default">
            <div class="panel-body">My Profile <i class="fa fa-link fa-1x"></i></div>
            <div class="panel-body"><a href="{{route('website.appointment.history')}}">My Appointment</a></div>
            <div class="panel-body"><a href="{{route('payment.history')}}">Payment</a></div>
